# Telegram Bot API Update examples.
...
Update object with `message` and `group_chat_created` field.
...
Update object with `message` and `venue` field.
...
Update object with `message` and `new_chat_photo` field.
...
Update object with `message` and `left_chat_member` field.
...
Update object with `message` and `pinned_message` field.
...
Update object with `message` and `video` field.
...
Update object with `message` and `new_chat_members` field.
...
Update object with `message` and `new_chat_title` field.
...
Update object with `message` and `migrate_to_chat_id` field.
...
Update object with `message` and `channel_chat_created` field.
...
Update object with `message` and `entities` field.
...
Update object with `message` and `supergroup_chat_created` field.
...
Update object with `message` and `reply_to_message` field.
...
Update object with `message` and `contact` field.
...
Update object with `message` and `delete_chat_photo` field.
...
Update object with `message` and `edit_date` field.
...
Update object with `message` and `video_note` field.
...
Update object with `message` and `author_signature` field.
...
Update object with `message` and `migrate_from_chat_id` field.
